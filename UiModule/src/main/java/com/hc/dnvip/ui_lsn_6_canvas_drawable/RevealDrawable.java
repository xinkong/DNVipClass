...
//        Rect r = getBounds();
//        Rect clipContent = new Rect();
//        //绘制一一半的灰色区域
//        canvas.save();
//        //Gravity用于裁剪一个矩形区域
//        Gravity.apply(Gravity.LEFT, r.width()/2, r.height(), r, clipContent);
//        canvas.clipRect(clipContent);
//        mUnselectedDrawable.draw(canvas);
//        canvas.restore();
//
//        canvas.save();
//        Gravity.apply(Gravity.RIGHT, r.width()/2, r.height(), r, clipContent);
//        canvas.clipRect(clipContent);
